...
editorSuite('ExtensionManager', () => {
  ...
  describe('activateExtensions()', () => {
    it('should registExtensions', async t => {
      let res = await session.doAction('registerExtensions')
  ...
  describe('activationEvents', () => {
    ...
    it('should activate on language', async t => {
      ...
      await session.waitValue(() => ext.isActive, true)
    ...
    it('should activate on file system', async t => {
      ...
      let doc = {
        ...
        filetype: 'zip',
        winids: [],
        // editorSuite's afterEach reset wipes all documents; the fake buffer
  ...
  describe('watchExtension()', () => {
    it('should throw when watchman not found', async t => {
      ...
      await assert.rejects(fn(), Error)
      await assert.rejects(session.doAction('watchExtension', 'not_exists_extension'), /not found/)
    })
