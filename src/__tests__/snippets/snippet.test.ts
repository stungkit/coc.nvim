...
editorSuite('SnippetString', () => {
  it('should check SnippetString', t => {
  ...
  it('should build snippet string', t => {
  ...
  it('should escape/apply snippet choices correctly', t => {
    {
...
editorSuite('toSnippetString()', () => {
  it('should convert snippet to string', async t => {
    assert.throws(() => {
...
editorSuite('CocSnippet', () => {
  ...
  async function assertPyxValue(code: string, res: any) {
    ...
    if (typeof res === 'number' || typeof res === 'string' || typeof res === 'boolean') {
      ...
      assert.match(val, new RegExp(res))
    } else {
  ...
  describe('resolveVariables()', () => {
    ...
    it('should resolve uppercase variables', async t => {
      let doc = await session.createDocument()
    ...
    it('should resolve new VSCode variables', async t => {
      let doc = await session.createDocument()
      ...
      assert.match(c.text, new RegExp(path.basename(fsPath)))
    ...
    it('should resolve variables in placeholders', async t => {
      await nvim.setLine('foo')
    ...
    it('should resolve variables  with default value', async t => {
      await assertResult('$1 ${1:${VISUAL:foo}}', 'foo foo')
    })

    it('should resolve for lower case variables', async t => {
  ...
  describe('getUltiSnipOption', () => {
    it('should get snippets option', async t => {
  ...
  describe('findParent()', () => {
    it('should throw when not found', async t => {
    ...
    it('should not use adjacent choice placeholder', async t => {
  ...
  describe('replaceWithText()', () => {
    it('should not return undefined when no change', async t => {
    ...
    it('should replace with Text for choice placeholder', async t => {
    ...
    it('should not insert line break at the start of placeholder', async t => {
    ...
    it('should return undefined when cursor not changed', async t => {
    ...
    it('should synchronize without related change', async t => {
    ...
    it('should prefer current placeholder', async t => {
      let m: Placeholder
    ...
    it('should insert with marker', async t => {
      let c; let m
    ...
    it('should insert inside text', async t => {
    ...
    it('should change final placeholder', async t => {
    ...
    it('should replace with Text when placeholder is not primary', async t => {
  ...
  describe('replaceWithSnippet()', () => {
    it('should insert nested placeholder', async t => {
      let c = await createSnippet('${1:foo}\n$1', {})
    ...
    it('should insert python snippet to normal snippet', async t => {
      let c = await createSnippet('${1:foo}\n$1', {})
    ...
    it('should not change match for original placeholders', async t => {
    ...
    it('should update with independent python global', async t => {
    ...
    it('should not throw when parent not exist', async t => {
      let c = await createSnippet('${1:foo}', {})
      await c.onMarkerUpdate(new Placeholder(1), CancellationToken.None)
    })

    it('should not synchronize with none primary placeholder change', async t => {
      let c = await createSnippet('${1:foo}\n$1', {})
  ...
  describe('getMarkerPosition', () => {
    it('should get position of marker', async t => {
      let c = await createSnippet('${1:foo}')
  ...
  describe('code block initialize', () => {
    ...
    it('should setup python globals', async t => {
      await session.edit('t.js')
    ...
    it('should setup python match', async t => {
    ...
    it('should work with methods of snip', async t => {
    ...
    it('should init python code block', async t => {
    ...
    it('should init python placeholder', async t => {
    ...
    it('should init nested python placeholder', async t => {
    ...
    it('should recursive init python placeholder', async t => {
    ...
    it('should update python block from placeholder', async t => {
  ...
  describe('updatePlaceholder()', () => {
    ...
    it('should work with snip.c', async t => {
      let code = [
        '#ifndef ${1:`!p',
        'if not snip.c:',
      ...
      await c.tmSnippet.update(nvim, p.marker, CancellationToken.None)
      let text = c.tmSnippet.toString()
      assert.strictEqual(text.startsWith(first), true)
      assert.deepStrictEqual(text.split('\n').map(s => s.endsWith('foo')), [true, true, true])
    })

    it('should update placeholder with code blocks', async t => {
    ...
    it('should update related python blocks', async t => {
      // multiple
    ...
    it('should update python code blocks with normal placeholder values', async t => {
    ...
    it('should reset values for removed placeholders', async t => {
  ...
  describe('getNextPlaceholder()', () => {
    it('should get next placeholder', async t => {
    ...
    it('should not throw when next not exists', async t => {
    ...
    it('should prefer primary placeholder', async t => {
  ...
  describe('getUltiSnipActionCodes()', () => {
    it('should not get codes when action not exists', t => {
    ...
    it('should get codes when exists action', async t => {
      let snip = (new SnippetParser()).parse('${1:a}', true)
  ...
  describe('getRanges getSnippetPlaceholders getTabStops', () => {
    it('should get ranges of placeholder', async t => {
    ...
    it('should get range of marker snippet', async t => {
      let c = await createSnippet('${1:foo}', {})
    ...
    it('should get snippet tabstops', async t => {
      let c = await createSnippet('${1:foo}', {})
      let p = new Placeholder(1)
  ...
  describe('utils', () => {
    ...
    it('should throw for invalid regex', async t => {
      assertThrow(() => {
        convertRegex('\\z')
      })
      assertThrow(() => {
    ...
    it('should convert regex', async t => {
      // \\A
    ...
    it('should catch error with executePythonCode', async t => {
      let fn = async () => {
    ...
    it('should set error with addPythonTryCatch', async t => {
      ...
      assert.match(String(msg), new RegExp('INVALID_CODE'))
    })
    ...
    it('should parse comments', async t => {
    ...
    it('should set request variable', async t => {
