...
describe('Client integration', () => {
  ...
  before(async () => {
    ...
    const clientOptions: LanguageClientOptions = {
      ...
      outputChannel: session.createNullChannel(),
  ...
  beforeEach(async () => {
    ...
    await session.waitValue(() => Array.from(openFeature.openDocuments).includes(document), true)
  ...
  test('SignatureHelpRequest', async t => {
    await session.waitValue(() => client.getFeature(SignatureHelpRequest.method).getProvider(document) != null, true)
  ...
  test('CodeLens', async t => {
    ...
    await session.waitValue(() => fireRefresh, true)
  })
...
describe('Server activation', () => {
  ...
  test('Start server on language feature', async t => {
    ...
    await session.doAction('declarations')
    await started
    await client.stop()
  })
})
