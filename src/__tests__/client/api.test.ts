...
editorSuite('ProgressPart', () => {
  ...
  it('should report progress', async t => {
    ...
    await session.waitValue(async () => (await nvim.call('coc#notify#win_list') as number[]).length, 1)
